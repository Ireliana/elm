<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <ratingselect @toggle-content="toggleContent" @type-change="typeChange" :select-type="selectType" :only-content="onlyContent" :ratings="ratings"></ratingselect>
      <div class="rating-wrapper">
        <ul>
          <li v-for="(rating,key) in ratings" :key="key" class="rating-item border-1px" v-show="needShow(rating.text,rating.rateType)">
            <div class="avatar">
